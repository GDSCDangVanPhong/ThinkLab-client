<template>
  ...
  <div v-if="editor">
    <div class="flex gap-x-10">
      <div class="w-9/12" >
        <div
          class="flex flex-wrap items-center gap-1 rounded-bl-md rounded-br-md border border-input bg-transparent p-1 w-full "
        >
          <UiButton
            size="sm"
            variant="outline"
      ...
      <div>
        <UiCard class="lg:min-h-[786px] w-96">
          <UiCardHeader>
            <UiCardTitle>
              Chat With AI
            </UiCardTitle>
