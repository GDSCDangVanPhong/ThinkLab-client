<template>
  ...
  >
    ...
    <motion.div
        :class="[
        'absolute left-1/2 top-[-71.5%] z-[3] h-[140%] w-[30%] rounded-b-full op-40 mix-blend-plus-darker blur-3xl [background-position:0%_100%] [background-size:100%_150%] [transform:translate3d(-50%,0,0)] dark:mix-blend-plus-lighter',
